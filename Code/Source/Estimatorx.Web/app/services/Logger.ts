...
module Estimatorx {
    ...
    export class Logger {
        ...
        constructor(toastr: angular.toastr.IToastrService) {
            ...
            self.toastr = toastr;
            self.handelErrorProxy = angular.bind(self, self.handelError) as (response: any) => angular.IPromise<any>;
        }
        ...
        handelErrorProxy: (response: any) => angular.IPromise<any> | any;
        ...
        handelError(response) {
            ...
            if (response.status === 400)
                message = self.extractModelState(response.data);
            else if (response.status === 500)
                message = self.extractServerError(response.data);
